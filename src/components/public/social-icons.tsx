 ...
 *
 * lucide-react v1 removed all brand icons (Facebook, Linkedin, Twitter,
 * Youtube), so they cannot be imported from there — importing them fails to
 * typecheck. These are the official marks, drawn as single paths and inheriting
 * `currentColor`.
 */
